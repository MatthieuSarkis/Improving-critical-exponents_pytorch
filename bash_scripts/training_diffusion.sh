...
#SBATCH --output="OUTPUT_training_ising.out" # job standard output file (%j replaced by job id)
#SBATCH --error="ERROR_training_ising.out" # job standard error file (%j replaced by job id)
