...
#SBATCH --output="OUTPUT_training.out" # job standard output file (%j replaced by job id)
#SBATCH --error="ERROR_training.out" # job standard error file (%j replaced by job id)
